...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] private Transform _billThrowTransform;
    ...
    private void Awake()
    {
        ...
        _offset = transform.position.x - _billThrowTransform.position.x;
    ...
    public void ChangeBoundary(float extraWidth)
    {
        ...
        _leftBound += ThrowBillController.instance.Bounds.extents.x + extraWidth;
        _rightBound -= ThrowBillController.instance.Bounds.extents.x + extraWidth;
    }
}
